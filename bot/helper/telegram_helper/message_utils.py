...
def update_all_messages():
    ...
    msg += f"<b>🖥সিপিইউ:</b>{psutil.cpu_percent()}%" \
           f"<b>💾র‍্যাম:</b>{psutil.virtual_memory().percent}%" \
           f"<b>💿ডিস্কস্পেস:</b>{psutil.disk_usage('/').percent}%"
    with download_dict_lock:
        ...
        msg += f"\n<b>🔥ফ্রি স্পেস:</b> {free} | <b>\n⏰আপটাইম:</b> {currentTime}\n<b>╔●● ডাউনলোড স্পীড:</b> {dlspeed}/s 🔻\n<b>╚●● আপলোড স্পীড:</b>  {ulspeed}/s 🔺\n\n"
    with status_reply_dict_lock:
...
def sendStatusMessage(msg, bot):
    ...
    progress += f"<b>🖥সিপিইউ:</b>{psutil.cpu_percent()}%" \
           f"<b>💾র‍্যাম:</b>{psutil.virtual_memory().percent}%" \
           f"<b>💿ডিস্কস্পেস:</b>{psutil.disk_usage('/').percent}%"
    with download_dict_lock:
        dlspeed_bytes = 0
